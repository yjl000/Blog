...
library SerialityBinaryStream {
    ...
    function readBytes(BinaryStream memory self) internal pure returns (bytes memory) {
    ...
    function readString(BinaryStream memory self) internal pure returns (string memory) {
    ...
    function writeBytes(BinaryStream memory self, bytes memory value) internal pure {
    ...
    function writeString(BinaryStream memory self, string memory value) internal pure {
    ...
    function memcpy(bytes memory src, bytes memory dest, uint len, uint destStartIndex) private pure {
        uint destPtr;
        uint srcPtr;
        assembly {
