...
library ZBSerializer {
    ...
    function serializeCardInstance(SerialityBinaryStream.BinaryStream memory stream, ZBGameMode.CardInstance memory card) private pure {
    ...
    function deserializeCardInstance(SerialityBinaryStream.BinaryStream memory stream) private pure returns (ZBGameMode.CardInstance memory) {
    ...
    function serializeCardInstanceArray(SerialityBinaryStream.BinaryStream memory stream, ZBGameMode.CardInstance[] memory cards) internal pure {
    ...
    function deserializeCardInstanceArray(SerialityBinaryStream.BinaryStream memory stream) private pure returns (ZBGameMode.CardInstance[] memory) {
    ...
    function deserializeDeck(SerialityBinaryStream.BinaryStream memory stream) private pure returns (ZBGameMode.Deck memory) {
    ...
    function changeMouldName(ZBGameMode.CardInstance memory self, string memory mouldName) internal pure {
    ...
    function emitGameStateChanges(SerializedGameStateChanges memory self) internal {
    ...
    function changePlayerCardsInDeck(
        ...
        ZBGameMode.Player player,
        ZBGameMode.CardInstance[] memory cards,
        uint cardCount
        ) internal pure {
        require(
    ...
    function getBytes(SerializedCustomUi memory self) internal pure returns (bytes memory) {
        return self.stream.buffer;
    }

    function add(SerializedCustomUi memory self, ZBGameMode.CustomUiLabel memory label) internal pure {
        SerialityBinaryStream.BinaryStream memory stream = self.stream;
    ...
    function add(SerializedCustomUi memory self, ZBGameMode.CustomUiButton memory button) internal pure {
        SerialityBinaryStream.BinaryStream memory stream = self.stream;
    ...
    function serializeStartCustomUiElement(
        ...
        ZBGameMode.Rect memory rect
        ) private pure {
        serializeStartCustomUiElement(stream, element);
        serializeRect(stream, rect);
    }

    function serializeRect(SerialityBinaryStream.BinaryStream memory stream, ZBGameMode.Rect memory rect) private pure {
        serializeVector2Int(stream, rect.position);
        serializeVector2Int(stream, rect.size);
    }

    function serializeVector2Int(SerialityBinaryStream.BinaryStream memory stream, ZBGameMode.Vector2Int memory v) private pure {
